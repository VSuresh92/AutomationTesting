...
public class ArrayInterviewQuesns {
	...
	public static void main(String[] args) {
		...
		ArrayInterviewQuesns.findPositiveNegative();
	...
	public static void SoringArray() {
		...
		System.out.println("The second minimum value is : " + a[1]);
		for (int i = 0; i < a.length; i++) {
			for (int j = i + 1; j < a.length; j++) {
				if (a[i] < a[j]) {
					c = a[i];
		...
		System.out.println("The second maximum value is : " + a[1]);
	}
	...
	// Quesn 6
	public static void findDuplicateLinkedHashSet() {
	...
	// Quesn 7
	public static void findDuplicateHashSet() {
		...
		System.out.println("Duplicate count of A is " + count);
	...
	public static void findPositiveNegative() {
		...
		for (int i = 0; i < a.length; i++) {
			if (a[i] > 0) {
				...
				System.out.println("Positive number in array is : " + a[i]);
			} else if (a[i] < 0) {
